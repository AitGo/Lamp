...
import com.rbu.lamphouse.message.model.UnReadModel;
import com.rbu.lamphouse.message.model.UnReadModelImpl;
import com.rbu.lamphouse.message.view.MessageInfoActivity;
import com.rbu.lamphouse.message.view.UnReadView;
...
public class UnReadPersenterImpl implements UnReadPersenter {
    private Context     mContext;
    private UnReadView  mView;
    private UnReadModel mModel;


    public UnReadPersenterImpl(Context context, UnReadView view) {
        this.mContext = context;
        this.mView = view;
        mModel = new UnReadModelImpl(context);
    }

    @Override
    public void initData(final int pageNum, final int pageSize, int state, final boolean isClear) {
    ...
    @Override
    public void initData(final int pageNum, final int pageSize, int state, final RefreshLayout refreshlayout, final int type) {
    ...
    @Override
    public void initRecycler(MessageAdapter adapter) {
