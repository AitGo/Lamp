...
import com.rbu.lamphouse.user.persenter.coupon.OverduePersenter;
import com.rbu.lamphouse.user.persenter.coupon.OverduePersenterImpl;
import com.rbu.lamphouse.user.persenter.coupon.UnusedPersenter;
...
public class OverdueFragment extends BaseFragment implements OverdueView{
    private OverduePersenter mPersenter;
    ...
    protected void initView(View inflate) {
        mPersenter = new OverduePersenterImpl(getContext(),this);
        this.inflate = inflate;
        mRecyclerView = inflate.findViewById(R.id.overdue_recyceler);
