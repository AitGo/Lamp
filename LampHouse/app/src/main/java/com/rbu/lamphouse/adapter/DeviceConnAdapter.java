...
public class DeviceConnAdapter extends MyBaseAdapter {
    ...
    public DeviceConnAdapter(Context context, List list) {
        super(list);
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(convertView == null) {
            holder = new Holder();
            convertView = LayoutInflater.from(mContext).inflate(R.layout.item_conn,null);
            holder.bluetoothName = convertView.findViewById(R.id.conn_name);
