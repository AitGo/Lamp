...
import com.rbu.lamphouse.user.persenter.coupon.UnusedPersenterImpl;
...
public class UnusedFragment extends BaseFragment implements UnusedView{

    private UnusedPersenter mPersenter;
    ...
    protected void initView(View inflate) {
        mPersenter = new UnusedPersenterImpl(getContext(),this);
        this.inflate = inflate;
        mRecyclerView = inflate.findViewById(R.id.unused_recyceler);
    ...
    protected void initData() {
        ...
        mAdapter.setCopyBtnVisibility(true);
