...
public class UsedPersenterImpl implements UsedPersenter {
    private Context   mContext;
    private UsedView  mView;
    private UsedModel mModel;

    public UsedPersenterImpl(Context context,UsedView view) {
        this.mContext = context;
        this.mView = view;
        this.mModel = new UsedModelImpl(context);
    }
